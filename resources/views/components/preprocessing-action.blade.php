<div
  class="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-xl mx-auto p-3">
  <div class="w-full sm:w-auto">
    <form action="{{ route('preprocessing.delete.all') }}" method="POST"
  ...
  <div class="w-full sm:w-auto">
    <button type="button" data-modal-target="import-modal"
...
<div id="import-modal" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative p-4 w-full max-w-xl max-h-full">
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
      ...
      <div class="p-4 md:p-5">
        <form class="space-y-4" action="{{ route('preprocessing.import') }}"
          enctype="multipart/form-data" id="importForm" method="POST">
          @csrf
          <div>
            <label for="file"
            ...
            @error('file')
              <small class="text-red-500 font-medium text-xs"> {{ $message }}</small>
            @enderror
          </div>
