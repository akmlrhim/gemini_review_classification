<div class="flex items-center justify-center gap-3 max-w-xl mx-auto p-3">
  <form class="flex-grow" action="{{ route('preprocessing.search') }}" method="GET">
    @csrf
  ...
  <div class="inline-flex rounded-md shadow-xs" role="group">
    ...
    <button type="button" onclick="window.location.href='{{ route('import.index') }}'"
      class="px-4 py-2 text-sm font-medium text-green-700 bg-white border border-gray-200 rounded hover:bg-gray-100 uppercase">
      IMPORT
    </button>
