<x-layout>
  ...
  <div class="ml-6">
    <button type="button" onclick="window.location.href='{{ route('manage-user.create') }}'"
        ...
        <tbody>
          @foreach ($users as $user)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
              <td class="px-3 py-2 font-medium text-gray-600 whitespace-nowrap dark:text-white">
              ...
              <td class="px-3 py-2 font-medium text-gray-600 whitespace-nowrap dark:text-white capitalize">
                {{ $user->role }}
              </td>
              <td class="px-3 py-2 font-medium text-gray-600 whitespace-nowrap dark:text-white capitalize">
                {{ $user->status }}
